...
namespace vmml {
    ...
    public:
        ...
        template< typename T_init >
        stats cp_als(const t3_type& data_, T_init init, const size_t max_iterations_ = 100);
        //        template< size_t NBLOCKS, typename T_init >
        //        void idecompose(const t3_type& data_, T_init init, const size_t max_iterations_ = 100);
        template< size_t NBLOCKS, typename T_init >
        stats i_cp_als(const t3_type& data_, T_init init, const size_t max_iterations_ = 100);
