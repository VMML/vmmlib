...
// *
// * Simple extension of cp3, to support the incremental algorithm (zang & golub 2001)
// * 
// */
//
//#ifndef __VMML__ICP3_TENSOR__HPP__
//#define __VMML__ICP3_TENSOR__HPP__
//
...
//namespace vmml {
//
//    template< size_t R, size_t NBLOCKS, size_t I1, size_t I2, size_t I3, typename T_value = float, typename T_coeff = float>
//            class icp3_tensor {
//    public:
...
//
//        typedef matrix< I1, R*NBLOCKS, T_coeff > u1_type;
//        typedef typename u1_type::iterator u1_iterator;
//        typedef typename u1_type::const_iterator u1_const_iterator;
//
//        typedef matrix< I2, R*NBLOCKS, T_coeff > u2_type;
//        typedef typename u2_type::iterator u2_iterator;
//        typedef typename u2_type::const_iterator u2_const_iterator;
//
//        typedef matrix< I3, R*NBLOCKS, T_coeff > u3_type;
//        typedef typename u3_type::iterator u3_iterator;
//        typedef typename u3_type::const_iterator u3_const_iterator;
//
//        typedef matrix< I1, R*NBLOCKS, T_internal > u1_comp_type;
//        typedef matrix< I2, R*NBLOCKS, T_internal > u2_comp_type;
//        typedef matrix< I3, R*NBLOCKS, T_internal > u3_comp_type;
//
//        typedef vector< R*NBLOCKS, T_internal > lambda_comp_type;
//        typedef vector< R*NBLOCKS, T_coeff > lambda_type;
//
//        icp3_tensor(u1_type& U1, u2_type& U2, u3_type& U3, lambda_type& lambdas_);
//        icp3_tensor();
//        ~icp3_tensor();
//
...
//        template< typename T_init >
//        void icp_als(const t3_type& data_, T_init init, const size_t max_iterations_ = 100);
//
//        size_t nnz() const;
//
//    protected:
//
//        icp3_tensor(const cp3_tensor< R, I1, I1, I1, T_value, T_coeff >& other) {
//        };
//
//        icp3_tensor< R, NBLOCKS, I1, I1, I1, T_value, T_coeff > operator=(const icp3_tensor< R, NBLOCKS, I1, I1, I1, T_value, T_coeff >& other) {
//            return *this;
//        };
//
//        void cast_members();
...
//
//
//#define VMML_TEMPLATE_STRING			template< size_t R, size_t R_incr, size_t I1, size_t I2, size_t I3, typename T_value, typename T_coeff >
//#define VMML_TEMPLATE_CLASSNAME			icp3_tensor< R, R_incr, I1, I2, I3, T_value, T_coeff >
//
//    VMML_TEMPLATE_STRING
//    VMML_TEMPLATE_CLASSNAME::icp3_tensor(u1_type& U1, u2_type& U2, u3_type& U3, lambda_type& lambdas_) {
...
//
//    VMML_TEMPLATE_STRING
//    VMML_TEMPLATE_CLASSNAME::icp3_tensor() {
//        _lambdas = new vector< R*R_incr, T_coeff > ();
//        _lambdas->set(0);
//        _u1 = new u1_type();
//        _u1->zero();
//        _u2 = new u2_type();
...
//        _u3 = new u3_type();
//        _u3->zero();
//        _lambdas_comp = new vector< R*R_incr, T_internal>;
//        _lambdas_comp->set(0);
...
//
//        typedef t3_ihopm< R, R_incr, I1, I2, I3, T_internal > ihopm_type;
//        ihopm_type::reconstruct(data, *_u1_comp, *_u2_comp, *_u3_comp, *_lambdas_comp);
//
...
//        icp_als(data_, init, max_iterations_);
//    }
//
//    VMML_TEMPLATE_STRING
//    template< typename T_init >
//    void
//    VMML_TEMPLATE_CLASSNAME::icp_als(const t3_type& data_, T_init init, const size_t max_iterations_) {
//        t3_comp_type data;
//        data.cast_from(data_);
//
//        typedef t3_ihopm< R, R_incr, I1, I2, I3, T_internal > ihopm_type;
//        ihopm_type::incremental_als(data, *_u1_comp, *_u2_comp, *_u3_comp, *_lambdas_comp, init, max_iterations_);
//
//        cast_members();
//    }
//
