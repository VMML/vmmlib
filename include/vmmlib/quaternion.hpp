...
template < typename float_t >
float_t quaternion< float_t >::dot( const quaternion< float_t >& a, const quaternion< float_t >& b )
{
...
template < typename float_t >
quaternion< float_t > quaternion< float_t >::slerp ( float_t a, const quaternion< float_t >& p, const quaternion< float_t >& q )
{
	p = p.normalize();
	q = q.normalize();
