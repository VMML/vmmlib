...
namespace vmml
{
	...
	matrix_pseudoinverse_test::run()
	{
		...
		compute_pseudoinverse< matrix< 6, 4, float_t > > compute_pinv;
		matrix< 6, 4, float_t > input;
		float_t data[] = { 0.8147, 0.9058, 0.1270, 0.9134, 
		...
		matrix< 4, 6, float_t > pseudoinverse_control;
		float_t data3[] = {
		...
		matrix< 6, 4, float_t > pseudoinverse_transposed;
                compute_pinv( input, pseudoinverse_transposed );

		matrix< 4, 6, float_t > pseudoinverse = transpose( pseudoinverse_transposed );
