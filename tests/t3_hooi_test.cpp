...
namespace vmml
{
	...
	t3_hooi_test::run()
	{
		...
		double data_u1[] = { -0.2789474111071824, -0.4141266306147135, 0.5983607967045262, -0.7806355076145295, 0.7511009910815754, 0.4680890279285661 }; //original from paper (u1): {-0.2789, -0.4141, 0.5984, -0.7806, 0.7511, 0.4681};
		u1_check.set( data_u1, data_u1 + 6);
		double data_u2[] = { -0.09816424894941811, -0.9951702267593202, -0.9951702267593202, 0.098164248949418 }; //original in paper (u2): 0.0982, -0.9952, 0.9952, 0.0982};
		...
		t3_hooi< 2, 2, 1, 3, 2, 2, double >::als( t3_data, u1, u2, u3, core );
